...
| Project | Description |
| --- | --- |
| [py-snowfall-threading](https://github.com/FarnooshMemari/py-snowfall-threading) · [multiprocessing](https://github.com/FarnooshMemari/py-snowfall-multiprocessing) · [async](https://github.com/FarnooshMemari/py-snowfall-async) | Snowfall game built three ways to compare concurrency models |
| [py-search-sort-algorithms](https://github.com/FarnooshMemari/py-search-sort-algorithms) · [gui](https://github.com/FarnooshMemari/py-search-sort-gui) | Sorting and search algorithms, as a CLI and a Tkinter app |
| [py-inventory-flask-sqlite](https://github.com/FarnooshMemari/py-inventory-flask-sqlite) · [gui](https://github.com/FarnooshMemari/py-inventory-gui-sqlite) | Inventory CRUD apps with Flask and PySimpleGUI on SQLite |
